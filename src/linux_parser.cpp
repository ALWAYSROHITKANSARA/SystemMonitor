...
float LinuxParser::MemoryUtilization() { 
  ...
  //As mentioned at this link https://knowledge.udacity.com/questions/153663
...
long LinuxParser::Jiffies() { 
  //using reference for total jiffies calculation https://knowledge.udacity.com/questions/129844
...
long LinuxParser::ActiveJiffies(int pid) { 
  ...
  //took reference from https://knowledge.udacity.com/questions/123769
...
long LinuxParser::ActiveJiffies() { 
  ...
  //using command /proc/stat we get ten token in the first line. Activejiffies = sum(ten tokens) for system
